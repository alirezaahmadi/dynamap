...
void runSLAM(void) {
  ...
  // Mine
  // Xtion.f.x = 542.576870f;
  // Xtion.f.y = 542.576870f;
  // Xtion.c.x = 315.593520f;
  // Xtion.c.y = 237.756098f;
  // // //  TUM
  // Xtion.f.x = 919.456298828125f;
  // Xtion.f.y = 920.6524047851562f;
  // Xtion.c.x = 361.7205505371094f;
  // Xtion.c.y = 636.787841796875f;
  // // // //  TUM
  Xtion.f.x = 525.0f;
  Xtion.f.y = 525.0f;
  Xtion.c.x = 319.5f;
  ...
  // Bunny
  // Xtion.c.x = 316.473843f;
  // Xtion.c.y = 243.262082f;
  // Xtion.f.x = 538.925221;
  // Xtion.f.y = 538.925221;

  Xtion.depthScaler = 5000.0f;
  Xtion.rows = 480;
  Xtion.cols = 640;
  
  // Initializing GaussianKernel for Bilateral Filter **************************
  gKernel.diameter = 8;
  gKernel.sigmaI = 10.0f;
  gKernel.sigmaS = 1.0f;
  // Initializing GaussNewton LS Properties ************************************
  OptimizerProp.lvlIterationNum[0] = 0;
  OptimizerProp.lvlIterationNum[1] = 0;
  OptimizerProp.lvlIterationNum[2] = 20;
  OptimizerProp.lvlScale[0] = 4;
  OptimizerProp.lvlScale[1] = 2;
  OptimizerProp.lvlScale[2] = 1;
  OptimizerProp.minIncrement = 0.001f;
  OptimizerProp.maxIncrement = 0.3f;
  OptimizerProp.regularization = 0.02f;
  OptimizerProp.huberConstant = 0.3f;
  ...
  // Dataset.depthPrefix = "depth_";
  // Dataset.rgbPrefix = "color_";
  // Dataset.rgbSuffix = ".png";
  // Dataset.depthSuffix = ".png";
  ...
  Dataset.loadData();
  // TSDF Representation Config ***********************************************
  // Options for the TSDF representation
  tsdfProp.voxelSize = 0.01f;
  tsdfProp.numBuckets = 2500;
  tsdfProp.bucketSize = 10;
  tsdfProp.numBlocks = 25000;
  tsdfProp.blockSize = 8;
  tsdfProp.maxSDFWeight = 64;
  tsdfProp.truncationDistance = 0.05f;
  tsdfProp.maxSensorDepth = DEPTH_MAX;
  tsdfProp.minSensorDepth = DEPTH_MIN;
