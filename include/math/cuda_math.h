...
// float3 functions
////////////////////////////////////////////////////////////////////////////////
// friend std::ostream& operator<<(std::ostream& os, float3& q){
//     os << "x: "<< q.x << ", y: "<< q.y << ", z: " << q.z ;
//     return os;
// }
// additional constructors
...
// operator <
static __inline__ __host__ __device__ bool operator < (float3 &a, float b)
{
    return (a.x < b && a.y < b && a.z < b) ? true : false;
} 
// operator ==
static __inline__ __host__ __device__ bool operator == (float3 &a, float3 b)
{
...
// inline __host__ __device__ bool isZero(float3 v){
...
// friend std::ostream& operator<<(std::ostream& os, float4 q){
